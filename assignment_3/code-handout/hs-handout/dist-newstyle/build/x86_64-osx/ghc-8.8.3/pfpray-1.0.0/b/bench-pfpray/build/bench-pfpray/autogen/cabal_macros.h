...
/* package pfpray-1.0.0 */
#ifndef VERSION_pfpray
#define VERSION_pfpray "1.0.0"
#endif /* VERSION_pfpray */
#ifndef MIN_VERSION_pfpray
#define MIN_VERSION_pfpray(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_pfpray */
...
#define CURRENT_COMPONENT_ID "pfpray-1.0.0-inplace-bench-pfpray"
